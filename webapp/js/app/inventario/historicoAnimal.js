...
$scope.getPesos = function () {
    ...
    $scope.getSaltos = function () {
      $scope.saltos=null;
      $http.get('http://52.39.15.75:1345/salto/?idArticulo='+MyService.data.articuloConsultado.id).then(function (resp) {
    ...
    $scope.getPromedio =function(){
      ...
      $http.get('http://52.39.15.75:1345/ordeno').then(function (resp) {
